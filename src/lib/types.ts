...
export type LocalizedArticle = { title: string; quick_brief: QuickBrief; full_article: FullArticle; audioUrl?: string; translationStatus: 'pending' | 'processing' | 'ready' | 'failed'; audioStatus: 'pending' | 'processing' | 'ready' | 'failed'; originalHash?: string; };
