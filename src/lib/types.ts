...
export type LocalizedArticle = { title: string; quick_brief: QuickBrief; full_article: FullArticle; audioUrl?: string; translationStatus: 'pending' | 'processing' | 'ready' | 'failed'; audioStatus: 'pending' | 'processing' | 'ready' | 'failed'; originalHash?: string; processingStartedAt?: number | null; };
export type Article = { id: string; schema_version: number; status: string; title: string; category: string; articleCategory?: string; quick_brief: QuickBrief; full_article: FullArticle; blocks?: unknown[]; mediaUrls?: string[]; imageUrl?: string; authorId?: string; authorName?: string; authorAvatar?: string; authorEmail?: string; createdAt?: Timestamp; updatedAt?: Timestamp; publishedAt?: Timestamp; scheduledAt?: Timestamp; isFeatured?: boolean; isTodaysDrop?: boolean; deckPriority?: number; views?: number; likesCount?: number; commentsCount?: number; raw_input?: string; languages?: Record<string, LocalizedArticle>; localizationBackfillAttempts?: number; localizationBackfillFirstPassAt?: number; };
